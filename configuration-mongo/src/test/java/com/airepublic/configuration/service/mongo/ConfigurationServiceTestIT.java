...
/**
 * Integrationtest for {@link ConfigurationServiceMongo}
 * 
 * @author Torsten.Oltmanns@ai-republic.com
 */
public class ConfigurationServiceTestIT {
	...
	public void saveAndGetConfigurationTest() throws Exception {
		...
		ConfigurationServiceMongo service = new ConfigurationServiceMongo();
		service.initialize();
	...
	public void saveConfigurationAsJsonTest() throws Exception {
		...
		service.saveConfigurationAsJson("{id:\"testConfiguration\", variation:\"\", test:\"helloAgain\"}");
